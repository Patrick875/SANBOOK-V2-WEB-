...
// 1.EditableTable should:
//   -- take an array strings as columns to serve as table head
//   -- take an array of strings as total rows
...
const EditableTable = (props) => {
	...
	const computeAmountVAT = (total) => {
		return type !== "delivery" ? Number((total * 18) / 100) : 0;
	};

	const computeFinalTotal = (total, amountVAT) => {
