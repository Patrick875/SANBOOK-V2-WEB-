		...
		<div>
			<form className="grid grid-cols-10 gap-2 mt-2">
					...
					<div className="w-4/5 mx-auto">
						...
						<div className="w-full">
							...
							<input
								...
								type=""
								value={employee && new Date(employee.birthdate).toDateString()}
						...
						<div className="flex w-full gap-3">
							...
							<div>
								...
								<select
									...
									<option
										selected={employee && employee.maritalstatus === "married"}
										value="married">
										Married
									</option>
								</select>
				...
				<div className="w-full col-span-3 px-4 pb-4 ">
					<div className="w-full ">
						<div className="w-18 text-white mx-auto h-[180px] ">
							<input type="file" id="profile" className="hidden " />
							<label
								htmlFor="profile"
								className="block w-full h-full border-black rounded-sm bg-slate-200 hover:bg-slate-300 border-1 text-primary-black ">
								<CiImageOn className="w-4/5 m-auto h-4/5" />
							</label>
						</div>
